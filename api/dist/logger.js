...
var _expressWinston = require('express-winston');var _expressWinston2 = _interopRequireDefault(_expressWinston);
...
var start = function start() {
  ...
  // Express middleware.
  log.express = _expressWinston2['default'].logger({
    transports: [
    consoleTransport,
    mongoTransport],
...
/* eslint-disable no-unused-vars */exports['default'] =
{
  start: start };